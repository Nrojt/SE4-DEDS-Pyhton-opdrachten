...
CREATE TABLE Order_details (
  ...
  ORDER_DETAILS_TOTAL_COST_total numeric(10,2) NOT NULL,
  ORDER_DETAILS_TOTAL_MARGIN_margin numeric(10,2) NOT NULL,
...
CREATE TABLE SALES_TARGETDATA (
  ...
  SALES_TARGETDATA_SALES_TARGET numeric(10,2) NOT NULL,
  SALES_TARGETDATA_TARGET_COST numeric(10,2) NOT NULL,

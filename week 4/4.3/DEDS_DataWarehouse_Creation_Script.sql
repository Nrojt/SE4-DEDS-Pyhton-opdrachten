...
CREATE TABLE Sales_staff (
  ...
  SALES_STAFF_POSITION_EN_position varchar(50) NULL,
  SALES_STAFF_WORK_PHONE_work_phone varchar(50) NULL,
  ...
  SALES_STAFF_FAX varchar(50) NULL,
  SALES_STAFF_FIRST_NAME_first_name varchar(50) NULL,
  SALES_STAFF_LAST_NAME_last_name varchar(50) NULL,
  ...
  SALES_STAFF_SALES_BRANCH_ADDRESS1_address varchar(255) NULL,
...
CREATE TABLE "Order" (
  ...
  ORDER_ORDER_METHOD_EN_method varchar(50) NULL,
  LAST_UPDATED datetime2 NOT NULL DEFAULT SYSDATETIME(), -- Add LAST_UPDATED column
  CURRENT_VALUE bit NOT NULL DEFAULT 1 -- Add CURRENT column
);
...
CREATE TABLE Retailer_site (
  ...
  RETAILER_SITE_CITY_city varchar(50) NULL,
  RETAILER_SITE_REGION_region varchar(50) NULL,
...
CREATE TABLE Retailer_segment (
  ...
  RETAILER_SEGMENT_segment_name varchar(50) NULL,
  RETAILER_SEGMENT_SEGMENT_DESCRIPTION_description varchar(255) NULL,
...
CREATE TABLE Retailer_headquarter (
  ...
  RETAIL_HEADQUARTER_retailer_name varchar(50) NULL,
  ...
  RETAILER_HEADQUARTER_region_region varchar(50) NULL,
  RETAILER_HEADQUARTER_city_city varchar(50) NULL,
  RETAILER_HEADQUARTER_postal_zone_postal_zone varchar(20) NULL,
  RETAILER_HEADQUARTER_fax_fax varchar(50) NULL,
  RETAILER_HEADQUARTER_phone_phone varchar(50) NULL,
...
CREATE TABLE Sales_branch (
  ...
  SALES_BRANCH_CITY_city varchar(50) NULL,
  SALES_BRANCH_POSTAL_ZONE_postal_zone varchar(20) NULL,
  SALES_BRANCH_ADDRESS1_address varchar(255) NULL,
  SALES_BRANCH_ADDRESS2_address varchar(255) NULL,
...
CREATE TABLE Retailer_contact (
  ...
  RETAILER_CONTACT_JOB_POSITION_EN_position varchar(50) NULL,
  RETAILER_CONTACT_EXTENSION_extension varchar(50) NULL,
  RETAILER_CONTACT_FAX_fax varchar(50) NULL,
  RETAILER_CONTACT_GENDER_gender char(1),
  RETAILER_CONTACT_FIRST_NAME_first_name varchar(50) NULL,
  RETAILER_CONTACT_LAST_NAME_last_name varchar(50) NULL,
...
CREATE TABLE Retailer (
  ...
  RETAILER_RETAILER_TYPE_EN varchar(50) NULL,
  LAST_UPDATED datetime2 NOT NULL DEFAULT SYSDATETIME(), -- Add LAST_UPDATED column
  CURRENT_VALUE bit NOT NULL DEFAULT 1 -- Add CURRENT column
);
...
CREATE TABLE Product (
  ...
  PRODUCT_name_product VARCHAR(255) NULL,
  PRODUCT_description_description VARCHAR(255) NULL,
  PRODUCT_image_image VARCHAR(255) NULL, -- url to image
  ...
  PRODUCT_LANGUAGE_language VARCHAR(5) NULL,
  PRODUCT_MINIMUM_SALE_PRICE_minPrice AS (PRODUCT_PRODUCTION_COST_cost + PRODUCT_MARGIN_margin),
  PRODUCT_PRODUCT_LINE_code varchar(50) NULL,
  PRODUCT_PRODUCT_LINE_code_en VARCHAR(50) NULL,
  PRODUCT_PRODUCT_TYPE_code varchar(50) NULL,
  PRODUCT_PRODUCT_TYPE_code_en VARCHAR(50) NULL,
  LAST_UPDATED datetime2 NOT NULL DEFAULT SYSDATETIME(), -- Add LAST_UPDATED column
  CURRENT_VALUE bit NOT NULL DEFAULT 1 -- Add CURRENT column
);
...
CREATE TABLE Order_details (
  ...
  ORDER_DETAILS_RETURN_CODE_returned varchar(50) NULL,
...
CREATE TABLE Returned_item (
  ...
  RETURNED_ITEM_RETURN_REASON_description_en VARCHAR(255) NULL,
...
CREATE TABLE SALES_TARGETDATA (
  ...
  SALES_TARGETDATA_SALES_PERIOD varchar(50) NULL,
  SALES_TARGETDATA_RETAILER_NAME varchar(255) NULL,
...
CREATE TABLE Satisfaction (
  ...
  PRIMARY KEY (SATISFACTION_SALES_STAFF_CODE, SATISFACTION_SATISFACTION_TYPE_CODE, SATISFACTION_YEAR),  -- Use composite primary key for unique combination
...
CREATE TABLE Order_header (
  ...
  ORDER_HEADER_ORDER_order_number int NOT NULL,
  FOREIGN KEY (ORDER_HEADER_ORDER_order_number) REFERENCES "Order"(ORDER_SK),
  LAST_UPDATED datetime2 NOT NULL DEFAULT SYSDATETIME(), -- Add LAST_UPDATED column
  CURRENT_VALUE bit NOT NULL DEFAULT 1 -- Add CURRENT column
);

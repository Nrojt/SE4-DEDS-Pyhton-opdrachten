...
(
    SALES_DEMOGRAPHIC_SK INT PRIMARY KEY IDENTITY (1,1), -- Use auto-incrementing ID as primary key
    SALES_DEMOGRAPHIC_AGE_GROUP_CODE INT NOT NULL,
    SALES_DEMOGRAPHIC_UPPER_AGE INT NOT NULL,
    SALES_DEMOGRAPHIC_LOWER_AGE INT NOT NULL,
    SALES_DEMOGRAPHIC_code INT NOT NULL,
    SALES_DEMOGRAPHIC_RETAILER_CODE INT NOT NULL REFERENCES Retailer_headquarter(RETAILER_HEADQUARTER_SK),
    SALES_DEMOGRAPHIC_SALES_PERCENT INT NOT NULL
);
GO
